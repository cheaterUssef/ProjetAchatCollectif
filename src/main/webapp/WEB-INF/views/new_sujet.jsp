...
<link href="<c:url value='/static/css/animate.min.css' />" rel="stylesheet" type="text/css" media="all" /><!-- animation -->
...
<script src="<c:url value='/static/js/jquery-scrolltofixed-min.js' />" type="text/javascript"></script><!-- fixed nav js -->
<script>
...
<body>
		...
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				<ul>
					...
					<li class="dropdown head-dpdn">
						<a href="<c:url value='/newsujet' />" class="dropdown-toggle"><i class="fa fa-credit-card-alt" aria-hidden="true"></i> Add Article</a>
	...
	<div class="login-page">
		<div class="container"> 
			<h3 class="w3ls-title w3ls-title1">Create your Subject</h3>  
			<div class="login-body">
				<form:form method="POST" modelAttribute="sujet">
					<form:input type="hidden" path="id" id="id"/>
					
					<form:input type="text" path="name" id="name" name="name" placeholder="Enter the subject name" class="user" />
                    <div class="has-error">
                    	<form:errors path="name" class="help-inline"/>
                    </div>
                    
                    <form:input type="text" path="description" id="description" name="description" class="user" placeholder="Enter the Description" />
                    <div class="has-error">
                        <form:errors path="description" class="help-inline"/>
                    </div>
                    
                    <form:input type="number" path="prix_original" min="0" id="prix_original" name="prix_original" class="user form-control input-lg" placeholder="Enter the original price (DH)"/>
                    <div class="has-error">
                    ...
                    <form:input type="number" path="nombre_max_adherent" min="1" id="nombre_max_adherent" name="nombre_max_adherent" class="user form-control input-lg" placeholder="Enter the max number of subscribers"/>
                    <div class="has-error">
                    ...
                    <form:input type="number" path="taux_reduction" id="taux_reduction" min="1" max="100" class="user form-control input-lg" name="taux_reduction" placeholder="Enter the discount rate (taux de réduction)" />
                    <div class="has-error">
                    ...
                    <form:input type="number" path="duree_validite" id="duree_validite" min="15" class="user form-control input-lg" name="duree_validite" placeholder="Enter the period of validity (days)" />
                    <div class="has-error">
                    ...
                    <form:select path="sujet_type" items="${types}" itemValue="id" itemLabel="type" class="form-control input-lg" />
                    <div class="has-error">
                    ...
                    <c:choose>
                        <c:when test="${edit}">
                            <input type="submit" value="Update" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/sujet/all' />">Cancel</a>
                        </c:when>
                        <c:otherwise>
                            <input type="submit" value="Create" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/sujet/all' />">Cancel</a>
                        </c:otherwise>
                    </c:choose>
				</form:form>
			</div>  
