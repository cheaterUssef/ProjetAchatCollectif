		...
		<div class="container"> 
			...
			<div class="login-body">
				...
				<form action="${loginUrl}" method="post">
					...
					<input type="text" class="user" id="username" name="ssoId" placeholder="Enter your email" required>
					<input type="password" id="password" name="password" class="lock" placeholder="Password" required>
					<input type="submit" value="Login">
					<div class="forgot-grid">
						<label class="checkbox"><input type="checkbox" id="rememberme" name="remember-me"><i></i>Remember me</label>
						<div class="forgot">
			...
			<h6> Not a Member? <a href="<c:url value='/newuser' />">Sign Up Now »</a> </h6> 
