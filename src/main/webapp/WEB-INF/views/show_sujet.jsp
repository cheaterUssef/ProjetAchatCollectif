...
<!--flex slider-->
<script defer src="<c:url value='/static/js/jquery.flexslider.js' />"></script>
<link rel="stylesheet" href="<c:url value='/static/css/flexslider.css' />" type="text/css" media="screen" />
<script>
