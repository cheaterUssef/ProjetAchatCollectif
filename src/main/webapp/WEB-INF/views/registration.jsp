		...
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				<ul>
					...
					<li class="dropdown head-dpdn">
						<a href="<c:url value='/sujet/newsujet' />" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-credit-card-alt" aria-hidden="true"></i>Add Article<span class="caret"></span></a>
		...
		<div class="container"> 
			...
			<div class="login-body">
				...
				<form:form method="POST" modelAttribute="user">
					...
					<form:input type="text" path="firstName" id="firstName" name="firstName" placeholder="Enter your first name" class="user" />
                    <div class="has-error">
                    	<form:errors path="firstName" class="help-inline"/>
                    </div>
                    
                    <form:input type="text" path="lastName" id="lastName" name="lastName" class="user" placeholder="Enter your last name" />
                    <div class="has-error">
                    ...
                    <c:choose>
                            <c:when test="${edit}">
                                <form:input type="text" path="ssoId" id="ssoId" class="user" disabled="true"/>
                            </c:when>
                            <c:otherwise>
                                <form:input type="text" path="ssoId" id="ssoId" class="user" placeholder="Enter your Login" />
                   				<div class="has-error">
                    ...
                    <form:input type="password" path="password" id="password" name="password" class="lock" placeholder="Password" />
                        <div class="has-error">
                            <form:errors path="password" class="help-inline"/>
                        </div>
                        
                    <form:input type="text" path="email" id="email" class="user" name="email" placeholder="Enter your email" />
                        <div class="has-error">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <input type="submit" value="Sign Up" class="btn btn-primary btn-sm"/> or <a href="<c:url value='sujet/all' />">Cancel</a>
                        </c:otherwise>
                    </c:choose>
			...
			<h6>Already have an account? <a href="<c:url value='/login' />">Login Now »</a> </h6>  
		</div>
	</div>
	<!-- //sign up-page --> 
	<!-- footer-top -->
