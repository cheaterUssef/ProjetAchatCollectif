...
<title>Smart Bazaar an E-commerce Online Shopping </title>
...
<link href="<c:url value='/static/css/menu.css' />" rel="stylesheet" type="text/css" media="all" /> <!-- menu style --> 
<link href="<c:url value='/static/css/ken-burns.css' />" rel="stylesheet" type="text/css" media="all" /> <!-- banner slider --> 
<link href="<c:url value='/static/css/animate.min.css' />" rel="stylesheet" type="text/css" media="all" /> 
<link href="<c:url value='/static/css/owl.carousel.css' />" rel="stylesheet" type="text/css" media="all"> <!-- carousel slider -->  
<!-- //Custom Theme files -->
<!-- font-awesome icons -->
...
<!-- web-fonts --> 
<script src="<c:url value='/static/js/owl.carousel.js' />"></script>  
<script>
...
<script src="<c:url value='/static/js/jquery-scrolltofixed-min.js' />" type="text/javascript"></script>
<script>
    $(document).ready(function() {
	...
	<div class="header">
		<div class="w3ls-header"><!--header-one--> 
			<div class="w3ls-header-left">
				<p><a href="<c:url value='/sujet/all' />">UPTO $50 OFF ON LAPTOPS | USE COUPON CODE LAPPY </a></p>
			</div>
		...
		<div class="header-three"><!-- header-three -->
			<div class="container">
				...
				<div class="move-text">
					...
					<script type="text/javascript" src="<c:url value='/static/js/jquery.marquee.min.js' />"></script>
					<script>
		...
		<div id="kb" class="carousel kb_elastic animate_text kb_wrapper" data-ride="carousel" data-interval="6000" data-pause="hover">
            ...
            <div class="carousel-inner" role="listbox">  
                <div class="item active"><!-- First-Slide -->
                    <img src="<c:url value='/static/images/5.jpg'/>" alt="" class="img-responsive" />
                ...
                <div class="item"> <!-- Second-Slide -->
                    <img src="<c:url value='/static/images/8.jpg'/>" alt="" class="img-responsive" />
                    <div class="carousel-caption kb_caption kb_caption_right">
                ...
                <div class="item"><!-- Third-Slide -->
                    <img src="<c:url value='/static/images/3.jpg'/>" alt="" class="img-responsive"/>
								 ...
								 <c:forEach items="${sujets}" var="sujet">
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="<c:url value='/sujet/${sujet.id}/show' />"><img src="<c:url value='/static/images/e1.png'/>" alt="img"></a>
...
<%-- 												    </sec:authorize>	  --%>
<!-- <!-- 												    <button type="submit" class="w3ls-cart" disabled><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button> --> 
<!-- <!-- 												    <h5>But sign in First</h5> --> 
<%-- 												</form>  --%>
												 <sec:authorize access="hasRole('ADMIN') or hasRole('USER')">
						...
						<!-- 			<div class="item">
										<div class="glry-w3agile-grids agileits">
											...
											<a href="products.html"><img src="<c:url value='/static/images/e2.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											...
											<a href="products.html"><img src="<c:url value='/static/images/e3.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products.html"><img src="<c:url value='/static/images/e4.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products.html"><img src="<c:url value='/static/images/e1.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
						...
						<div role="tabpanel" class="tab-pane fade" id="carl" aria-labelledby="carl-tab">
							<div class="tabcontent-grids">
								...
								<div id="owl-demo1" class="owl-carousel"> 
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products1.html"><img src="<c:url value='/static/images/f1.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											...
											<a href="products1.html"><img src="<c:url value='/static/images/f2.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products1.html"><img src="<c:url value='/static/images/f3.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>New</h6></div>
											<a href="products1.html"><img src="<c:url value='/static/images/f4.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
							...
							<div class="tabcontent-grids">
								...
								<div id="owl-demo2" class="owl-carousel"> 
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>New</h6></div>
											<a href="products6.html"><img src="<c:url value='/static/images/p1.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>20% <br> Off</h6></div>
											<a href="products6.html"><img src="<c:url value='/static/images/p2.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item"> 
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>Sale</h6></div>
											<a href="products6.html"><img src="<c:url value='/static/images/p3.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products6.html"><img src="<c:url value='/static/images/p4.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
							...
							<div class="tabcontent-grids">
								...
								<div id="owl-demo3" class="owl-carousel"> 
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>Sale</h6></div>
											<a href="products3.html"><img src="<c:url value='/static/images/h1.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											...
											<a href="products3.html"><img src="<c:url value='/static/images/h2.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products3.html"><img src="<c:url value='/static/images/h3.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products3.html"><img src="<c:url value='/static/images/h4.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
							...
							<div class="tabcontent-grids">
								...
								<div id="owl-demo4" class="owl-carousel"> 
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>New</h6></div>
											<a href="products4.html"><img src="<c:url value='/static/images/s1.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products4.html"><img src="<c:url value='/static/images/s2.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<div class="new-tag"><h6>20% <br>Off</h6></div>
											<a href="products4.html"><img src="<c:url value='/static/images/s3.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
									...
									<div class="item">
										<div class="glry-w3agile-grids agileits"> 
											<a href="products4.html"><img src="<c:url value='/static/images/s4.png'/>" alt="img"></a>
											<div class="view-caption agileits-w3layouts">           
	...
	<!-- cart-js -->
	<script src="<c:url value='/static/js/minicart.js'/>"></script>
	<script>
        w3ls.render();
	...
	<!-- //cart-js -->	
	<!-- countdown.js -->	
	<script src="<c:url value='/static/js/jquery.knob.js'/>"></script>
	<script src="<c:url value='/static/js/jquery.throttle.js'/>"></script>
	<script src="<c:url value='/static/js/jquery.classycountdown.js'/>"></script>
		<script>
			$(document).ready(function() {
	...
	<!-- //countdown.js -->
	<!-- menu js aim -->
	<script src="<c:url value='/static/js/jquery.menu-aim.js'/>"> </script>
	<script src="<c:url value='/static/js/main.js'/>"></script> <!-- Resource jQuery -->
	<!-- //menu js aim --> 
